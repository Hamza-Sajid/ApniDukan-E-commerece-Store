...
function Cart() {
  ...
  let {shipping_fee, cart , total_price} = userCartConsumer();
  ...
  return (
    ...
    {/* ALL UI ELEMENT ARE GOING TO BE HERE */}
      ...
      {/* //product list item */}
      {
        ...
        {
         return(
          <div  className='flex m-auto w-3/4 justify-center items-center mt-6 shadows p-4 '>
            <div className='mr-4'>
          ...
          <div className='bg-gray-100  w-2/5  items-center '>
              ...
              <div className='flex flex-col'>
                  ...
                  <div className='w-4/5 flex mt-12  m-auto'>
                      <div className=' w-4/5'>
                        <Text className='font-medium newFont'>Jessica Taylor</Text>
                        

                        <Text className='font-thin text-sm newFont text-gray-600'>F-8 Markaz</Text>
              ...
              <div className='flex  flex-col mt-12  m-auto w-4/5'>
                  ...
                  <div className='mt-2'>
                    ...
                    <Text className='inline float-right newFont text-sm font-bold text-gray-600'>FREE!</Text>
                  </div>
            ...
            <div className='flex mt-10  w-3/4 justify-between'>
                <div className='ml-12'>
                  ...
                  <Text className='text-2xl font-bold text-gray-700'>PKR 3200</Text>
                </div>
