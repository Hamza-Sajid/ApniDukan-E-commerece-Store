              ...
              <div className="flex  flex-wrap md:flex-nowrap lg:flex-nowrap  justify-center w-full  lg:w-3/4 md:w-3/4 m-auto p-6 mb-20 ">
                <div className="   lg:w-1/2 md:w-1/2 md:block lg:block flex items-center relative  ">
                  <div className="flex   w-full justify-center  h-full lg:h-2/3 md:h-2/3">
                    <IconButton
                      ...
                      className=" -left-6 md:left-0 lg:left-0  absolute  md:relative lg:relative top-1/3  md:top-2/4 lg:top-2/4 "
                    />
                    ...
                    <IconButton
                      ...
                      className=" -right-6 lg:-right-0 md:-right-0  absolute md:relative lg:relative top-1/3 lg:top-2/4 md:top-2/4 "
                    />
                  </div>
                ...
                <div className="w-full lg:w-1/2 md:w-1/2  ml-0 md:ml-8 lg:ml-8 ">
                  ...
                  <div className="flex items-center">
                    <Text
                      fontSize="xl"
                      className=" md:hidden lg:hidden font-thin mr-4 md:mr-0 lg:mr-0 "
                    >
                      Rating
                    </Text>
                  ...
                  <h2 className="text-gray-500 mt-4 font-normal text-lg md:block lg:block hidden">
                    Quantity
                  </h2>
                  ...
                  <div className=" w-2/4 h-1/4 mt-4 hidden md:block lg:block">
                    <NavLink to="/cart">
                      <Button
                        onClick={() =>
                          addToCart(id, selectedColor, quantity, data)
                        }
                      ...
                      {colors &&
                        colors.map((e, index) => {
                          return (
                            <>
                              <button
                                onClick={() => changeColorValue(index)}
                                style={{ background: e }}
                  ...
                  <div className="md:hidden lg:hidden items-center flex justify-center mt-12">
                    <Text className="w-1/4 font-bold text-xl">Quantity</Text>
                    <NumberInput
                      className=" w-1/3"
                      size="md"
